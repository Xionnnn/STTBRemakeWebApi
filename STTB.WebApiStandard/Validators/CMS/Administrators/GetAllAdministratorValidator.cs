...
{
    public class GetAllAdministratorValidator : AbstractValidator<GetAllAdministratorRequest>
    {
        private static readonly string[] AllowedOrderByFields =
        {
            "Id", "Name", "Division", "Role", "CreatedAt"
        };

        private static readonly string[] AllowedOrderStates = { "asc", "desc" };

        public GetAllAdministratorValidator()
        {
