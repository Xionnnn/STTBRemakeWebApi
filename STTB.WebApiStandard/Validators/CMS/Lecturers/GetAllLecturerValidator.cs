...
{
    public class GetAllLecturerValidator : AbstractValidator<GetAllLecturerRequest>
    {
        private static readonly string[] AllowedOrderByFields =
        {
            "Id", "LecturerName", "OrganizationalRole", "IsActive", "JoinedAt", "CreatedAt"
        };

        private static readonly string[] AllowedOrderStates = { "asc", "desc" };

        public GetAllLecturerValidator()
        {
