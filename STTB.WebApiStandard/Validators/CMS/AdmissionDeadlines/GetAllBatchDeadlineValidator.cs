...
{
    public class GetAllBatchDeadlineValidator : AbstractValidator<GetAllBatchDeadlineRequest>
    {
        private static readonly string[] AllowedOrderByFields =
        {
            "Id", "AcademicYear", "BatchOrder", "BatchDeadlineAt", "IsActive", "CreatedAt"
        };

        private static readonly string[] AllowedOrderStates = { "asc", "desc" };

        public GetAllBatchDeadlineValidator()
        {
